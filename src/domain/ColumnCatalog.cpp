...
namespace ssa::domain {
    ...
    namespace {
        ...
        constexpr std::array<AdvancedFilterColumnDef, 14> kAdvancedFilterColumns{{
        ...
        const std::array<ColumnDef, 85> kColumns{{
            ...
            {"derivada_de", "Derivada de", "Derivada de", Text, true, true, 110},
            {"localizacao_codigo", "Loc.", "Localizacao", Text, true, true, 120},
            {"descricao_localizacao", "Desc. Loc.", "Descricao Local", Text, true, true, 220},
            {"equipamento", "Equip.", "Equipamento", Text, true, true, 150},
            ...
            {"qtd_derivadas", "Qtd. Derivadas", "Quantidade de derivadas", Integer, true, false,
             110},
