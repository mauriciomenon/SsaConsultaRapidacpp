...
- Preferences dialog with theme selection, visible column selection, column width editing, select
  all, defaults reset, detail panel visibility, local column filtering, apply, and close actions.
...
- Column visibility, column widths, page size, filters, detail panel visibility, and theme are persisted through
