...
| Update derivadas                                | `gui/gui_ssa.py::update_derivadas_from_sources`             | `IDerivadasPort::syncDerivadas`, `SsaWorkflowService`                              | Present                            |
...
| SAM REST refresh                                | Python `scrap_report` integration                           | `ISamRefreshPort`, `ScrapReportSamRefreshPort`, `SsaWorkflowService`               | Present, disabled by default       |
