...
Button {
    ...
    font.bold: false
    implicitWidth: Math.max(100, Math.ceil(implicitContentWidth + leftPadding + rightPadding))
    opacity: enabled ? 1.0 : 0.8
    readonly property bool quietAccent: Theme.gruvbox || Theme.themeName === "ssa-dark"
    readonly property color normalBackground: control.secondary ? Theme.panelRaised : (control.quietAccent ? Theme.panelRaised : Theme.accent)
    readonly property color hoverBackground: control.secondary ? Theme.rowAlt : Theme.accentSoft
    readonly property color downBackground: control.secondary ? Theme.panel : (control.quietAccent ? Theme.accent : Theme.accentStrong)
    ...
    readonly property color normalBorder: control.secondary ? Theme.border : (control.quietAccent ? Theme.border : (control.hovered ? Theme.accentStrong : Theme.accent))
    ...
    readonly property color preferredForeground: control.danger ? Theme.dangerStrong : control.secondary ? Theme.text : (control.quietAccent && !control.down ? Theme.accentStrong : Theme.accentText)
